...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
    <div class="w-container"><a href="#" class="w-nav-brand"><img src="images/bemo-logo2.png" width="170" height="100" srcset="images/bemo-logo2-p-500.png 500w, images/bemo-logo2-p-800.png 800w, images/bemo-logo2-p-1080.png 1080w, images/bemo-logo2.png 1398w" sizes="(max-width: 479px) 120px, 170px" alt="" class="image"></a>
      <nav role="navigation" class="nav-menu w-nav-menu">
        ...
        <a href="index.html" aria-current="page" class="nav-link w-nav-link w--current">Main</a>
  ...
  <div class="div-block-7">
    ...
    <div class="form-block-2 w-form">
      <form id="wf-form-Email-Form" name="wf-form-Email-Form" data-name="Email Form" class="form-2">
        <div class="text-block-7">Search Engine Visibility</div><label class="w-radio"><input type="radio" data-name="Radio" id="radio-2" name="radio" value="Radio 2" class="w-form-formradioinput radio-button-2 w-radio-input"><span class="radio-button-label-2 w-form-label">Page Visible</span></label><label class="w-radio"><input type="radio" data-name="Radio" id="radio" name="radio" value="Radio" class="w-form-formradioinput radio-button w-radio-input"><span class="radio-button-label w-form-label">Page Invisible</span></label></form>
  ...
  <div class="section">
    ...
    <div class="div-block-8"><img src="images/twitterBetter.png" width="25" alt="" class="image-9"><img src="images/facebookbetter.png" width="35" srcset="images/facebookbetter-p-500.png 500w, images/facebookbetter.png 640w" sizes="35px" alt="" class="image-8"></div>
  </div>
